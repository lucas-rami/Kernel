...
#
KERNEL_OBJS = console.o kernel.o loader.o malloc_wrappers.o interrupts.o keyboard.o keyboard_asm.o prechecks.o timer.o timer_asm.o queue.o page_fault_asm.o page_fault_handler.o virtual_memory.o bitmap.o
