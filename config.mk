...
# Files in syscalls/
KERNEL_OBJS += syscalls/gettid.o syscalls/scheduling_calls.o syscalls/fork.o syscalls/exec.o syscalls/pages.o syscalls/console_io.o syscalls/vanish.o syscalls/wait.o syscalls/swexn.o syscalls/set_status.o

# Files in syscalls/wrappers/
KERNEL_OBJS += syscalls/wrappers/gettid.o syscalls/wrappers/scheduling_calls.o syscalls/wrappers/fork.o syscalls/wrappers/syscalls_helper.o syscalls/wrappers/exec.o syscalls/wrappers/pages.o syscalls/wrappers/console_io.o syscalls/wrappers/vanish.o syscalls/wrappers/wait.o syscalls/wrappers/exec.o syscalls/wrappers/swexn.o syscalls/wrappers/set_status.o
